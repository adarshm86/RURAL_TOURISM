...
const seasonalData = [
  {
    ...
    image: 'https://images.slurrp.com/prodarticles/42s8x7ye2gx.webp',
  ...
  },
  {
    ...
    image: 'https://miro.medium.com/v2/resize:fit:1200/1*_j7l2T6RDWMv9vNYXd2tgQ@2x.jpeg',
  ...
  },
  {
    ...
    image: 'https://www.travelmalnad.com/storage/blog_fi/01KM0KV697FEZSNVZWF18F5348.png',
  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 transition-all duration-100 z-10" style={{ background: `rgba(0,0,0,${overlayOpacity})` }} />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
          ...
          >
            ...
            <button 
              ...
              className="px-8 py-3 border border-white/30 text-white rounded-full hover:border-earth-400 hover:text-earth-300 transition-all duration-300 font-body font-medium tracking-wide"
            >
              Watch Calendar
            </button>
          </motion.div>
          ...
          {/* Stats */}
          <motion.div
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5, delay: 1.5 }}
        ...
        {/* Scroll indicator */}
        <motion.div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20" animate={{ y: [0, 8, 0] }} transition={{ duration: 1.5, repeat: Infinity }}>
        ...
        <div className="w-1/3 lg:w-1/4 flex flex-col justify-center px-8 lg:px-12 z-20 bg-[#080f08] backdrop-blur-lg border-l border-white/5 shadow-2xl">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} transition={{ duration: 0.5, ease: "easeOut" }}
            >
      ...
      {/* ✅ Replaced the old hardcoded footer with your new clean component! */}
      <Footer />
